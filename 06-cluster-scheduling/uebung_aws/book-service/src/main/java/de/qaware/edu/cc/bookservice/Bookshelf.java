...
public class Bookshelf {
    ...
    public void initialize() {
        ...
        books.add(new Book("The Hitchhiker's Guide to the Galaxy", "Douglas Adams", "0345391802", storeId));
        books.add(new Book("The Martian", "Andy Weir", "0553418025", storeId));
        books.add(new Book("Guards! Guards!", "Terry Pratchett", "0062225758", storeId));
        books.add(new Book("Alice in Wonderland", "Lewis Carroll", "3458317422", storeId));
        books.add(new Book("Life, the Universe and Everything", "Douglas Adams", "0345391829", storeId));
    }
