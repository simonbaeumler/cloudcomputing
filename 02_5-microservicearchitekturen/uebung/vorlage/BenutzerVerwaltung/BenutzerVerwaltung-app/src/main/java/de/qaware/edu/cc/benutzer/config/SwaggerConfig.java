...
public class SwaggerConfig {
    ...
    public Docket swaggerSpringMvcPlugin(
            @Value("${BenutzerVerwaltung.swagger.title}") String title,
            @Value("${BenutzerVerwaltung.swagger.version}") String version,
            @Value("${BenutzerVerwaltung.swagger.description}") String description,
            @Value("${BenutzerVerwaltung.swagger.contact}") String contact) {
    ...
    private Predicate<String> paths() {
        return regex("/BenutzerVerwaltung/.*");
    }
}
